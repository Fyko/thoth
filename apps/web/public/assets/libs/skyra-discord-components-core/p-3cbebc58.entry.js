...
const f = (e, i = false, o = false) => {
	if (!(e instanceof Date) && typeof e !== 'string') {
		throw new TypeError(
			'Timestamp prop must be a Date object or a string.'
		);
	}
...
const b = (e) => {
	if (!u.test(e))
		throw new Error(
			`The url of an image for discord-attachment should match the regex ${u}`
		);
};
...
const x = (e) => {
	...
	let o;
	return (o =
		(i = window.$discordMessage) === null || i === void 0
			? void 0
			: i.emojis) === null || o === void 0
		? void 0
		: o[e];
};
...
const z = class {
	...
	handleType(e) {
		if (typeof e !== 'string') {
			...
			!['primary', 'secondary', 'success', 'destructive'].includes(e)
		) {
	...
	render() {
		...
		if (e.tagName.toLowerCase() !== 'discord-action-row') {
			throw new Error(
				'All <discord-button> components must be direct children of <discord-action-row>.'
			);
		}
...
const S = class {
	...
	render() {
		...
		if (c.tagName.toLowerCase() !== 'discord-message') {
			throw new Error(
				'All <discord-command> components must be direct children of <discord-message>.'
			);
		}
		...
		const a = (e) => {
			let i;
			let o;
			return (o = (i = d[e]) !== null && i !== void 0 ? i : e) !== null &&
				o !== void 0
				? o
				: d.default;
		};
		...
		const l =
			(e = Reflect.get(s, this.profile)) !== null && e !== void 0
				? e
				: {};
		const m = {
			...n,
			...l,
			avatar: a(
				(r = l.avatar) !== null && r !== void 0 ? r : this.avatar
			),
		};
...
const B = class {
	...
	componentWillRender() {
		...
		if (!this.url && Boolean(this.name)) {
			const s = x(this.name);
			if (s) {
				(e = this.url) !== null && e !== void 0
					? e
					: (this.url =
							(i = s.url) !== null && i !== void 0 ? i : '');
				(o = this.embedEmoji) !== null && o !== void 0
					? o
					: (this.embedEmoji =
							(r = s.embedEmoji) !== null && r !== void 0
								? r
								: false);
			}
		}
	...
	render() {
		const e = `:${this.name}:`;
		const o = this.embedEmoji
			? 'discord-embed-custom-emoji'
			: 'discord-custom-emoji';
		const r = this.embedEmoji
			? 'discord-embed-custom-emoji-image'
			: 'discord-custom-emoji-image';
		return i(
			'span',
			{ class: o },
			i('img', {
	...
	componentDidRender() {
		if (this.hasPerformedRerenderChecks === 'pristine') {
			try {
				...
				this.hasProvidedDescriptionSlot = Boolean(
					e === null || e === void 0 ? void 0 : e.innerHTML.trim()
				);
			} finally {
			...
			if (d.name) {
				t = i(
					...
					i('img', {
						src: d.url,
						alt: d.name,
						class: 'discord-embed-custom-emoji-image',
					}),
					i('span', null, ' ')
				);
			} else {
...
const $ = class {
	...
	render() {
		...
		if (e.tagName.toLowerCase() !== 'div') {
			throw new Error(
				'All <discord-embed-description> components must be direct children of <discord-embed>.'
			);
		}
...
const T = class {
	...
	checkInlineIndex(e) {
		if (!this.validInlineIndices.has(Number(e)))
			throw new RangeError(
				'DiscordEmbedField `inlineIndex` prop must be one of: 1, 2, or 3'
			);
	}
	...
	render() {
		...
		if (e.tagName.toLowerCase() !== 'discord-embed-fields') {
			throw new SyntaxError(
				'All <discord-embed-field> components must be direct children of <discord-embed-fields>.'
			);
		}
				...
				class: Z(
					{
						...
						'discord-embed-inline-field-1':
							this.inline && this.inlineIndex === 1,
						'discord-embed-inline-field-2':
							this.inline && this.inlineIndex === 2,
						'discord-embed-inline-field-3':
							this.inline && this.inlineIndex === 3,
					},
					'discord-embed-field'
				),
			},
...
T.style = R;
const D =
	'.discord-embed .discord-embed-fields{display:grid;grid-column:1/1;margin-top:8px;grid-gap:8px}';
const N = class {
	constructor(i) {
		e(this, i);
	}
...
const W = class {
	...
	render() {
		...
		if (e.tagName.toLowerCase() !== 'div') {
			throw new Error(
				'All <discord-embed-footer> components must be direct children of <discord-embed>.'
			);
		}
		...
		return i(
			...
			i(
				...
				i('slot', null),
				this.timestamp
					? i('span', { class: 'discord-footer-separator' }, '•')
					: '',
			...
			i(
				...
				i(
					...
					i(
						...
						((this.verified && !this.partnered) ||
							(!this.verified && this.partnered)) &&
							i(
								'div',
								{ class: 'discord-invite-badge' },
								i(P, {
									'aria-label': this.partnered
										? 'Discord Partner'
										: 'Verified',
								...
								i(
									...
									this.partnered ? i(F, null) : i(J, null)
								)
							),
...
const X = function e(i) {
	...
	const r = o
		? ''.concat(i.slice(0, 1)).concat(i.slice(0, 1))
		: i.slice(0, 2);
	const s = o
		? ''.concat(i.slice(1, 2)).concat(i.slice(1, 2))
		: i.slice(2, 4);
	const d = o
		? ''.concat(i.slice(2, 3)).concat(i.slice(2, 3))
		: i.slice(4, 6);
	const t =
		(o ? ''.concat(i.slice(3, 4)).concat(i.slice(3, 4)) : i.slice(6, 8)) ||
		'ff';
...
const he = class {
	...
	componentDidLoad() {
		if (this.color && this.type === 'role') {
			this.el.addEventListener(
				'mouseover',
				this.setHoverColor.bind(this)
			);
			this.el.addEventListener(
				'mouseout',
				this.resetHoverColor.bind(this)
			);
		}
	}
	...
	render() {
		...
		const s =
			!e || r !== 'role'
				? {}
				: { color: e, 'background-color': de(e, 0.1) };
		let d = '';
		switch (this.type) {
			case 'channel':
		...
		return i(
			o,
			{ style: s, class: `discord-mention discord-${r}-mention` },
			d,
			i('slot', null)
		);
	}
	...
	i(
		...
		!n &&
			i(
				...
				i(
					'span',
					{ class: 'discord-author-username', style: { color: d } },
					e
				),
				t &&
					i('img', {
		...
		i(
			...
			r &&
				!o &&
				i('span', { class: 'discord-application-tag' }, 'Server'),
			s &&
				i(
					'span',
					{
						class: 'discord-application-tag discord-application-tag-op',
					},
					'OP'
				)
		),
...
const be = class {
	...
	render() {
		...
		const z = {
			...
			...H,
			avatar: k(
				(r = H.avatar) !== null && r !== void 0 ? r : this.avatar
			),
		};
		const M =
			Array.from(this.el.children).some(
				(e) =>
					e.tagName.toLowerCase() === 'discord-mention' &&
					e.highlight &&
					['user', 'role'].includes(e.type)
			) || this.highlight;
		const V = Array.from(this.el.children).some(
			(e) => e.tagName.toLowerCase() === 'discord-thread'
		);
		return i(
			o,
			{
			...
			i(
				...
				i(
					...
					i('img', { src: z.avatar, alt: z.author })
				),
				i(
					'div',
					...
					!C.compactMode &&
						i(
							...
							i(pe, {
								author:
									(t = z.author) !== null && t !== void 0
										? t
										: '',
								bot:
									(c = z.bot) !== null && c !== void 0
										? c
										: false,
								server:
									(a = z.server) !== null && a !== void 0
										? a
										: false,
								verified:
									(n = z.verified) !== null && n !== void 0
										? n
										: false,
								op:
									(l = z.op) !== null && l !== void 0
										? l
										: false,
								roleColor:
									(m = z.roleColor) !== null && m !== void 0
										? m
										: '',
								roleIcon:
									(h = z.roleIcon) !== null && h !== void 0
										? h
										: '',
								roleName:
									(g = z.roleName) !== null && g !== void 0
										? g
										: '',
					...
					i(
						...
						C.compactMode &&
							i(pe, {
								author:
									(p = z.author) !== null && p !== void 0
										? p
										: '',
								bot:
									(f = z.bot) !== null && f !== void 0
										? f
										: false,
								server:
									(u = z.server) !== null && u !== void 0
										? u
										: false,
								verified:
									(b = z.verified) !== null && b !== void 0
										? b
										: false,
								op:
									(x = z.op) !== null && x !== void 0
										? x
										: false,
								roleColor:
									(v = z.roleColor) !== null && v !== void 0
										? v
										: '',
								roleIcon:
									(w = z.roleIcon) !== null && w !== void 0
										? w
										: '',
								roleName:
									(y = z.roleName) !== null && y !== void 0
										? y
										: '',
								compact: C.compactMode,
							}),
...
const Se = class {
	...
	render() {
		...
		if (c.tagName.toLowerCase() !== 'discord-message') {
			throw new Error(
				'All <discord-reply> components must be direct children of <discord-message>.'
			);
		}
		...
		return i(
			...
			i(
				...
				i('slot', null),
				this.edited
					? i('span', { class: 'discord-message-edited' }, '(edited)')
					: ''
			),
			this.command
				? i(ze, { class: 'discord-replied-message-content-icon' })
				: this.attachment &&
						i(He, { class: 'discord-replied-message-content-icon' })
		);
	}
...
const We = class {
	...
	handleType(e) {
		if (typeof e !== 'string') {
			throw new TypeError(
				'DiscordSystemMessage `type` prop must be a string.'
			);
		} else if (
			![
				'join',
	...
	render() {
		...
		if (e.tagName.toLowerCase() !== 'discord-messages') {
			throw new Error(
				'All <discord-system-message> components must be direct children of <discord-messages>.'
			);
		}
		...
		const s = Array.from(this.el.children).some(
			(e) => e.tagName.toLowerCase() === 'discord-thread'
		);
		return i(
			o,
			{
				class: Z(
					...
					`discord-${this.type}-system-message`,
					{
	...
	render() {
		return i(
			...
			i(
				...
				i(
					'span',
					{ class: 'discord-thread-cta', 'aria-hidden': 'true' },
					this.cta,
					' ›'
				)
			),
...
const Ge = class {
	...
	render() {
		...
		const n = {
			...
			...a,
			avatar: t(
				(r = a.avatar) !== null && r !== void 0 ? r : this.avatar
			),
		};
		return i(
			o,
...
Ge.style = Ye;
const Ke =
	'.discord-time{background-color:#ffffff0f;border-radius:3px;padding:0 2px}';
const Qe = class {
	constructor(i) {
		e(this, i);
	}
