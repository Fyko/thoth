  ...
  return (
    ...
    >
      <DiscordMessage profile="thoth">
        ...
        <DiscordCustomEmoji name="merriamWebster" /> <a>ostentatious</a>{" "}
        (adjective) • (os•ten•ta•tious) • (<a>ˌä-stən-ˈtā-shəs</a>)
        <p>
          Stems: ostentatious, ostentatiously, ostentatiousness,
          ostentatiousnesses
        </p>
        <br />
        <u>Definitions</u>
        <br />
        <br />
        <b>:</b> attracting or seeking to attract attention, admiration, or envy
        often by gaudiness or obviousness <b>:</b>
