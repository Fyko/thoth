import type SoundsLikeCommand from '@thoth/interactions/commands/general/sounds-like';
...
@injectable()
export default class<Cmd extends typeof SoundsLikeCommand> extends Command<Cmd> {
	public constructor(
	...
	public override async chatInput(
		...
		const words = await fetchDatamuse(DatamuseQuery.SoundsLike, args.word).catch(() => null);
