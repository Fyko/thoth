...
const TriggersCommand = {
	...
	description_localizations: fetchDataLocalizations('commands.triggers.meta.description'),
	options: [
		{
			name: 'word',
			name_localizations: fetchDataLocalizations('commands.triggers.meta.args.word.name'),
			description: i18n.t('commands.triggers.meta.args.word.description'),
			description_localizations: fetchDataLocalizations('commands.triggers.meta.args.word.description'),
