...
const SimilarSpellingCommand = {
  ...
  name_localizations: fetchDataLocalizations(
    "commands.similar-spelling.meta.name",
  ),
  description: i18n.t("commands.similar-spelling.meta.description"),
  description_localizations: fetchDataLocalizations(
    "commands.similar-spelling.meta.description",
  ),
  options: [
    {
      name: "word",
      name_localizations: fetchDataLocalizations(
        "commands.similar-spelling.meta.args.word.name",
      ),
      description: i18n.t(
        "commands.similar-spelling.meta.args.word.description",
      ),
      description_localizations: fetchDataLocalizations(
        "commands.similar-spelling.meta.args.word.description",
      ),
