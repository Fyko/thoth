...
const CloseRhymeCommand = {
	...
	name_localizations: fetchDataLocalizations(
		'commands.close-rhyme.meta.name'
	),
	description: i18n.t('commands.close-rhyme.meta.description'),
	description_localizations: fetchDataLocalizations(
		'commands.close-rhyme.meta.description'
	),
	options: [
		{
			name: 'word',
			name_localizations: fetchDataLocalizations(
				'commands.close-rhyme.meta.args.word.name'
			),
			description: i18n.t(
				'commands.close-rhyme.meta.args.word.description'
			),
			description_localizations: fetchDataLocalizations(
				'commands.close-rhyme.meta.args.word.description'
			),
