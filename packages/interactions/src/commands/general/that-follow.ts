...
const ThatFollowCommand = {
	...
	name_localizations: fetchDataLocalizations(
		'commands.that-follow.meta.name'
	),
	description: i18n.t('commands.that-follow.meta.description'),
	description_localizations: fetchDataLocalizations(
		'commands.that-follow.meta.description'
	),
	options: [
		{
			name: 'word',
			name_localizations: fetchDataLocalizations(
				'commands.that-follow.meta.args.word.name'
			),
			description: i18n.t(
				'commands.that-follow.meta.args.word.description'
			),
			description_localizations: fetchDataLocalizations(
				'commands.that-follow.meta.args.word.description'
			),
