...
const SoundsLikeCommand = {
	...
	name_localizations: fetchDataLocalizations(
		'commands.sounds-like.meta.name'
	),
	description: i18n.t('commands.sounds-like.meta.description'),
	description_localizations: fetchDataLocalizations(
		'commands.sounds-like.meta.description'
	),
	options: [
		{
			name: 'word',
			name_localizations: fetchDataLocalizations(
				'commands.sounds-like.meta.args.word.name'
			),
			description: i18n.t(
				'commands.sounds-like.meta.args.word.description'
			),
			description_localizations: fetchDataLocalizations(
				'commands.sounds-like.meta.args.word.description'
			),
