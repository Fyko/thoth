...
import TriggersCommand from '#interactions/commands/general/triggers.js';
...
type Arguments = ArgumentsOf<typeof TriggersCommand>;
...
export default class implements Command {
	public readonly data = TriggersCommand;
	...
	public exec = async (res: FastifyReply, interaction: APIInteraction, lng: string) => {
		...
		const response = await datamuse(`https://api.datamuse.com/words?rel_trg=${args.word}`);
