...
import RhymeCommand from '#interactions/commands/general/rhyme.js';
...
type Arguments = ArgumentsOf<typeof RhymeCommand>;
...
export default class implements Command {
	public readonly data = RhymeCommand;
