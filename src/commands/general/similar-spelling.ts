...
import SimilarSpellingCommand from '#interactions/commands/general/similar-spelling.js';
...
type Arguments = ArgumentsOf<typeof SimilarSpellingCommand>;
...
export default class implements Command {
	public readonly data = SimilarSpellingCommand;
