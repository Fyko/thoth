...
import HyponymsCommand from '#interactions/commands/general/hyponyms.js';
...
type Arguments = ArgumentsOf<typeof HyponymsCommand>;
...
export default class implements Command {
	public readonly data = HyponymsCommand;
	...
	public exec = async (res: FastifyReply, interaction: APIInteraction, lng: string) => {
		...
		const response = await datamuse(`https://api.datamuse.com/words?rel_gen=${args.word}`);
