...
import CloseRhymeCommand from '#interactions/commands/general/close-rhyme.js';
...
type Arguments = ArgumentsOf<typeof CloseRhymeCommand>;
...
export default class implements Command {
	...
	public exec = async (res: FastifyReply, interaction: APIInteraction, lng: string) => {
		...
		const response = await datamuse(`https://api.datamuse.com/words?rel_nry=${args.word}`);
