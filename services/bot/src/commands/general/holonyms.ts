...
import HolonymsCommand from '#interactions/commands/general/holonyms.js';
...
type Arguments = ArgumentsOf<typeof HolonymsCommand>;
...
export default class implements Command {
	public readonly data = HolonymsCommand;
	...
	public exec = async (res: FastifyReply, interaction: APIInteraction, lng: string) => {
		...
		const response = await datamuse(`https://api.datamuse.com/words?rel_com=${args.word}`);
